...
vault write data/bulletins/a title="Bulletin Board Page" \
...
vault write data/bulletins/b title="Usefulness" \
...
vault write data/bulletins/c title="Color-codeable" \
...
vault write data/bulletins/d title="Requirements" \
...
vault write data/bulletins/e title="Vault Maintenance" \
